  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center py-16 px-4 md:px-8 lg:px-16 overflow-hidden bg-[#faf9f6]">
      ...
      <div className="w-full max-w-6xl flex flex-col items-center z-10">
        ...
        {/* Hero Title & Headline */}
        <div className="relative text-center max-w-3xl mb-12">
        ...
        <div className="relative w-full flex flex-col md:flex-row items-center justify-between gap-12 mt-8">
          ...
          <div className="relative flex justify-center items-center w-full md:w-2/4 order-1 md:order-2">
            ...
            <div className="absolute bottom-0 w-[280px] sm:w-[350px] lg:w-[420px] h-[280px] sm:h-[350px] lg:h-[420px] rounded-full bg-[#fcd4ad] -z-10" />

            {/* Orange Backdrop Semicircle */}
            <div className="absolute bottom-0 w-[240px] sm:w-[300px] lg:w-[360px] h-[240px] sm:h-[300px] lg:h-[360px] rounded-full bg-linear-to-t from-primary to-[#ff9f4b] -z-10 shadow-[0_15px_40px_rgba(255,122,26,0.2)]" />

            {/* Helmi Portrait */}
            <div className="relative w-[230px] sm:w-[280px] lg:w-[340px] h-[280px] sm:h-[340px] lg:h-[410px] overflow-hidden flex items-end">
              <Image
                src="/image/hero/hero.png"
                alt="Helmi - Brand & Marketing Specialist"
                width={340}
                height={410}
                priority
                className="object-cover object-bottom filter drop-shadow-[0_8px_16px_rgba(0,0,0,0.15)] hover:scale-105 transition-all duration-500"
              />
            </div>

            {/* Floating Action Pills overlapping the bottom */}
            <div className="absolute bottom-4 flex items-center justify-center w-full px-4">
            ...
            <div className="absolute top-[10%] left-[-5%] sm:left-[5%] md:left-[-10%] lg:left-[0%] animate-float">
            ...
            <div className="absolute bottom-[20%] left-[-10%] sm:left-[0%] md:left-[-15%] lg:left-[-0%] animate-float-delayed">
            ...
            <div className="absolute top-[25%] right-[-5%] sm:right-[5%] md:right-[-10%] lg:right-[5%] animate-float-delayed">
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-white text-dark-charcoal shadow-lg text-xs md:text-sm font-semibold border border-white/10 hover:scale-105 hover:rotate-2 transition-all duration-300">
            ...
            <div className="absolute bottom-[15%] right-[-10%] sm:right-[0%] md:right-[-15%] lg:right-[-5%] animate-float">
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-white text-dark-charcoal shadow-lg text-xs md:text-sm font-semibold border border-white/10 hover:scale-105 hover:-rotate-3 transition-all duration-300">
